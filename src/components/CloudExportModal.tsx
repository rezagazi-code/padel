  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-md p-4 overflow-y-auto">
      <div className="relative w-full max-w-2xl rounded-3xl bg-white/[0.05] border border-white/10 p-6 sm:p-8 shadow-[0_20px_70px_rgba(0,0,0,0.8)] my-8 space-y-6 text-right text-xs">
        ...
        <div className="absolute bottom-0 left-1/4 w-72 h-72 bg-[#ff2d55]/10 rounded-full blur-3xl pointer-events-none" />

        {/* Header */}
        <div className="flex items-center justify-between pb-4 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-cyan-500/20 to-[#ff2d55]/20 border border-cyan-500/40 flex items-center justify-center text-cyan-400">
              <Cloud className="w-6 h-6" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-lg font-black text-slate-100">راهنمای خروجی کلود رایگان و نسخه‌های Android & iOS</h2>
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-xl bg-white/[0.04] hover:bg-white/10 text-slate-500 hover:text-slate-100 flex items-center justify-center transition cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="rounded-2xl bg-white/[0.06] border border-white/10 p-4 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] text-[#ff6b81] font-bold bg-red-950/60 border border-red-400/40 px-2 py-0.5 rounded-md">
              نصب فوری
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
            ...
            <div className="p-3.5 rounded-xl bg-white/[0.05] border border-white/10 space-y-2">
              ...
              <div className="bg-white/[0.05] p-2 rounded-lg border border-white/10 text-[10px] font-mono text-slate-400 ltr text-left">
            ...
            <div className="p-3.5 rounded-xl bg-white/[0.05] border border-white/10 space-y-2">
              ...
              <p className="text-[11px] text-slate-400 leading-relaxed">
                در گوشی‌های اپل بدون نیاز به اپ‌استور و تحریم‌ها، از طریق دکمه <strong className="text-slate-100">Share</strong> در مرورگر Safari و لمس گزینه <strong className="text-slate-100">Add to Home Screen</strong>، آیکون پدل‌پرو مثل اپلیکیشن بومی فول‌اسکرین اجرا می‌شود.
              </p>
              <div className="bg-white/[0.05] p-2 rounded-lg border border-white/10 text-[10px] font-mono text-slate-400 ltr text-left">
                npx cap add ios<br/>
                npx cap open ios
        ...
        <div className="p-4 rounded-2xl bg-gradient-to-r from-amber-500/10 via-white/[0.04] to-[#ff2d55]/10 border border-amber-500/30 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-gradient-to-r from-[#ff2d55] to-[#ff4d2d] text-white font-black text-xs shadow-md hover:opacity-95 transition cursor-pointer whitespace-nowrap"
          >
